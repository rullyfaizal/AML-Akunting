    ...
    Private Sub dgv1_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv1.CellDoubleClick
        If e.RowIndex >= 0 AndAlso e.ColumnIndex >= 0 Then
            ...
            ElseIf txt_baris.Text = "2" Then
                ...
                Else
                    ' REVISI: Logika perbandingan menggunakan angka Decimal dan Math.Round
                    Dim hargaAwal As Decimal = 0
                    Dim hargaBaru As Decimal = 0

                    Decimal.TryParse(form_input_penjualan_kain.txt_harga_jual_dpp.Text, hargaAwal)
                    Decimal.TryParse(row.Cells(11).Value.ToString(), hargaBaru)

                    If Math.Round(hargaAwal, 2) <> Math.Round(hargaBaru, 2) Then
