...
Public Class form_detail_grey

    Private Sub form_detail_grey_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

    End Sub

    Private Sub txt_kode_grey_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_kode_grey.TextChanged
    ...
    Private Sub isidgvindukgrey()
        Try
            ...
            Using conx As New MySqlConnection(sLocalConn)
                conx.Open()
                Dim sqlx As String = "SELECT * FROM tbhistorygrey WHERE kode_grey='" & txt_kode_grey.Text & "'"
